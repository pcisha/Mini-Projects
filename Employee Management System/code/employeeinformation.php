...
<body>
<form name="form1" method="post" action="employeeinsertintodb.php">
...
<td width="70%"><input type="text" name="phoneno" id="phoneno"></td>
</tr>
<tr>
<td  width="30%"> Email</td>
<td  width="70%"><input type="text" name="email" id="email"></td>
</tr>
<tr>
<td>Designation</td>
<td>
...
$dbc = mysqli_connect('silo.cs.indiana.edu', 'b561f13_amlakhan', 'password', 'b561f13_amlakhan')
  ...
  $result = mysqli_query($dbc, $query)
	...
	{
		echo '<input type="checkbox" class="skillsCheckBox" name="skills[]" value="'.$rowsk["skill_id"].'">'.$rowsk["skill_name"];
	}
	echo '<br>';
...
<input class="button" type="reset" name="Reset" value="Reset" onClick="clearValues()"></td>
</p>
</form> 
</body>
</html> 
