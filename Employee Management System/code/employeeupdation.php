...
$( document ).ready(function() {
	$('#searchId').val('');
	$('.skillsCheckbox').prop('checked', false);
  	$('#second').hide();

	$("#getInfoBtn").click(function() {
			var searchValue = $('#searchId').val();
						
			$.getJSON('getinfo.php',{'search':searchValue},function(data){
					{
						...
						$.getJSON('getskills.php',{'search':searchValue},function(data){
						{
...
<div id="first">
<p align="center">
<font color='#FFFFFF' face='courier' size='3'> Enter the Employee ID:</font>
<input type="text" id="searchId" name="searchId">
<input class="button" name="button" type="submit" value="Get Information" id="getInfoBtn"/>
</p>

</div>

<div id="second">
<form name="form1" method="post" action="hrupdateintodb.php">
