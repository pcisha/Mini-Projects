...
// Add a combiner here, not required to successfully run the wordcount program  ///
    job.setCombinerClass(Reduce.class);	//The job will execute an instance of the Reducer class which will enable some aggregation and thereby some optimization
